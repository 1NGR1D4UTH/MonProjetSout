                ...
                <tbody id="employeTableBody">
                    <tr v-for="user in employe" :key="user.id">
                        ...
                        <td> 
                            ...
                            <i class="fas fa-edit" @click="showEditModal(user)" style="cursor: pointer; color: blue; margin-right: 10px;" title="Modifier"></i>
                            <i class="fas fa-trash" @click="deleteModal(user.email)" style="cursor: pointer; color: red;" title="Supprimer"></i>
                        </td>
